...
function [pars, Init] = load_pars_Init_Copeland_Fitted(data)
...
xdn= 10; %97 .06 | 10
hmD= 6; %107 2 
alpha=  135.7 ; %98 3|100


%%------------------Nitric oxide equation parameters------------------------
knom  =  0.0011118 ;   %  0.002|
kno   = 0.045;   % .045 |
xntnf = 100;      % 70|
hntnf = 2;       % 2|
xn10  = 5;       % 4|
...
pars = [k10   k10m   k6    k6m   k8      k8m    ktnf  ktnfm kma    kmpe ...  %1 - 10
        ...
        sM  kmp               ... %100-101
        kD xDam hmDa xm10D hm10D hmD knod xnDl10 hnDl10 xn10D hn10D ktnfhr BPo                                      ]'; %102-112